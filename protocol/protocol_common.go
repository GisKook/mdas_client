...
const (
	...
	PROTOCOL_REQ_RESTART uint16 = 0x0003
	PROTOCOL_REP_RESTART uint16 = 0x8003
	...
	PROTOCOL_REP_GET_SERIAL_STATUS uint16 = 0x8011
	PROTOCOL_REQ_GET_SERIAL_STATUS uint16 = 0x0011
